//
//  MOCALevelFinishViewController.m
//  ADTestLabs
//
...
@interface MOCALevelFinishViewController ()
...
@implementation MOCALevelFinishViewController
...
- (void)CompleteQuestionScore
{
    ...
    if (_appDelegate.user != nil)
    {
        [_scaleReportBLL AddScaleReport:_appDelegate.user
         .userID withAnswer:nil withScore:score withScaleReportDesc:reportText withScaleLevelTag:ScaleLevelMOCA];
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"MOCALevelToShowHospitalLocationMapView"])
    {
